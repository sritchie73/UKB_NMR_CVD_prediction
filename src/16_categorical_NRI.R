...
saveRDS(nri_lists, file="analyses/test/discovery_categorical_nri.rds")
...
fwrite(nri_estimates, sep="\t", quote=FALSE, file="analyses/test/discovery_categorical_nri_estimates.txt")
fwrite(reclassified, sep="\t", quote=FALSE, file="analyses/test/discovery_categorical_nri_reclassified.txt")
