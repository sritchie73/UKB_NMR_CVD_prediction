...
# Write out
fwrite(pred_scores, sep="\t", quote=FALSE, file="analyses/CVD_weight_training/phase3_CVD_linear_predictors_and_risk.txt")
...
ggsave(g, width=7.2, height=5, file="analyses/CVD_weight_training/phase3_average_predicted_LP_by_age_group.pdf")
