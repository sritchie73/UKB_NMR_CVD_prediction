...
# ----------------------------------
# Show just non-derived biomarkers
# ----------------------------------
...
# Extract matrix of biomarker data
dat <- dat[,.SD,.SDcols=c("eid", ukbnmr::nmr_info[Type == "Non-derived", Biomarker])]
dat <- as.matrix(dat, rownames="eid")
...
ggsave(width=3.6, height=4, units="in", file="analyses/train/NMR_non_derived_biomarker_correlations.pdf")
...
ggsave(width=3.6, height=4, units="in", file="analyses/test/NMR_non_derived_biomarker_correlations.pdf")
