...
saveRDS(nri_lists, file="analyses/test/phase3_categorical_nri.rds")
...
fwrite(nri_estimates, sep="\t", quote=FALSE, file="analyses/test/phase3_categorical_nri_estimates.txt")
fwrite(reclassified, sep="\t", quote=FALSE, file="analyses/test/phase3_categorical_nri_reclassified.txt")
...
ggsave(g, width=7.2, height=3.5, file="analyses/test/phase3_categorical_NRI.pdf", device=cairo_pdf)
...
fwrite(risk, sep="\t", quote=FALSE, file="analyses/test/phase3_ESC_2021_risk_strata.txt")
...
# Write out
fwrite(dt, sep="\t", quote=FALSE, file="analyses/test/phase3_categorical_NRI_for_supp.txt")
