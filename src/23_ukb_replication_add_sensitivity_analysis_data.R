...
dat <- fread("data/cleaned/phase3_analysis_cohort.txt", select="eid")
...
fwrite(dat, sep="\t", quote=FALSE, file="data/cleaned/phase3_sensitivity_analysis_extended_data.txt")
