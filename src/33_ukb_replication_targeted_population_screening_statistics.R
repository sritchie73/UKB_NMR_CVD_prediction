...
boot_res <- fread("analyses/public_health_modelling/replication_standardised_targeted_risk_stratification_bootstraps.txt")
...
fwrite(res, sep="\t", quote=FALSE, file="analyses/public_health_modelling/replication_targeted_screening.txt")
