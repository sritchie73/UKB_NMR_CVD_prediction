...
boot_res <- fread("analyses/public_health_modelling/discovery_standardised_blanket_risk_stratification_bootstraps.txt")
...
fwrite(res, sep="\t", quote=FALSE, file="analyses/public_health_modelling/discovery_blanket_screening.txt")
