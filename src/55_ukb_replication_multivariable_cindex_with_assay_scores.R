...
pred_scores <- fread("analyses/CVD_weight_training/phase3_CVD_linear_predictors_and_risk_with_assay_scores.txt")
...
# Write out
fwrite(fits, sep="\t", quote=FALSE, file="analyses/test/replication_cindices_with_assay_scores.txt")
