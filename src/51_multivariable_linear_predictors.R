...
ggsave(g, width=7.2, height=5, file="analyses/CVD_weight_training/average_predicted_LP_wih_assay_scores_by_age_group.pdf")
...
ggsave(g, width=7.2, height=5, file="analyses/CVD_weight_training/new_LP_vs_SCORE2_LP_with_assay_scores_average_per_age_group.pdf")
