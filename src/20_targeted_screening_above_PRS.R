...
# Write out
fwrite(ons_conv_rf, sep="\t", quote=FALSE, file=sprintf("%s/conv_rf_prs_risk_stratified_by_age_sex.txt", out_dir))
fwrite(ons_conv_rf_summary, sep="\t", quote=FALSE, file=sprintf("%s/conv_rf_prs_risk_stratified.txt", out_dir))
...
# Write out
fwrite(ons_pred, sep="\t", quote=FALSE, file=sprintf("%s/targeted_biomarker_stratified_by_age_sex.txt", out_dir))
fwrite(ons_pred_summary, sep="\t", quote=FALSE, file=sprintf("%s/targeted_biomarker_stratified.txt", out_dir))
