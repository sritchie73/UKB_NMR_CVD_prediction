...
options(boot.ncpus=20) # Takes almost 3 hours on icelake with 20 cores
...
fwrite(res, sep="\t", quote=FALSE, file="analyses/public_health_modelling/replication_standardised_blanket_risk_stratification_bootstraps.txt")
