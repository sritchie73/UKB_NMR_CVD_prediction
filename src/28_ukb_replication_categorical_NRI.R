...
# Ran successfully in ~25 minutes using 15 cores on cclake partition
registerDoMC(10) 
setDTthreads(10)
...
saveRDS(nri_lists, file="analyses/test/replication_categorical_nri.rds")
...
fwrite(nri_estimates, sep="\t", quote=FALSE, file="analyses/test/replication_categorical_nri_estimates.txt")
fwrite(reclassified, sep="\t", quote=FALSE, file="analyses/test/replication_categorical_nri_reclassified.txt")
